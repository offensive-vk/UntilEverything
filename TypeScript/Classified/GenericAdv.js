...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var numberStringPair, stringBooleanPair;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, createKeyValuePair(1, "TypeScript")];
                case 1:
                    numberStringPair = _a.sent();
                    return [4 /*yield*/, createKeyValuePair("isTrue", true)];
                case 2:
                    stringBooleanPair = _a.sent();
