...
function isType<T extends { [key: string]: any }>(
  input: any,
...
function PerformAction<T extends { [key: string]: any }>(
  input: any,
  constructor: new (...args: any[]) => T,
): T {
...
class Dog extends Animal {
  constructor(name: string, public breed: string) {
    super(name);
    console.log(
      `New Animal named ${this.name} of ${this.breed} breed has been spawned.`,
    );
  }
}
